      ...
      <div className='about__left-side'>
        <div className='about__text-box'>
          ...
          <p className='about__text--2'>
            im passionate about creating software & web applications. im a perfectionist so i send 
        ...
        <div className='about__table'>
          <div className='about__table--1'>
            <div className='about__table--title'>Some things im great with</div>
          ...
          <div className='about__table--2'>
            <div className='about__table--title'>Some things im learning</div>
            <div className='about__table--list-box'>
              <ul className='about__table--list'>
